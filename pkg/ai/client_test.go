...
func TestDefaultConfig_Defaults(t *testing.T) {
	...
	assert.Equal(t, "https://api.openai.com/v1", cfg.BaseURL, "default base URL")
	assert.Equal(t, "gpt-4o", cfg.Model, "default model")
}
...
func TestDefaultConfig_WithEnv(t *testing.T) {
	...
	os.Setenv("LLM_AxonHub", "claude-opus-4")
